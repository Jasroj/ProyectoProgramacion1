...
private ArrayList<Selecion> tablaOFC = new ArrayList<>();
...
//te parece si comentas lo que intentaste para ver intentar la idea que llevaba ayer? es que ya se me hizo enredo :D jjjj si si sorry jejejeje
    ...
    {
         for (Selecion sele : this.getTablaOFC()) {
  ...
  public void setTablaPartido(ArrayList<Resultados> tablaPartido) {
     ...
     * @return the tablaOFC
     */
    public ArrayList<Selecion> getTablaOFC() {
        return tablaOFC;
    }

    /**
     * @param tablaOFC the tablaOFC to set
     */
    public void setTablaOFC(ArrayList<Selecion> tablaOFC) {
        this.tablaOFC = tablaOFC;
    }
}

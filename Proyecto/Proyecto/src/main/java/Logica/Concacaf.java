 ...
 * @author JRS
 */
public class Concacaf {
    private ArrayList<Resultados> tablaPartido = new ArrayList<>();
    private ArrayList<Selecion> tablaConcacaf = new ArrayList<>();
...
//te parece si comentas lo que intentaste para ver intentar la idea que llevaba ayer? es que ya se me hizo enredo :D jjjj si si sorry jejejeje
    ...
    {
         for (Selecion sele : this.getTablaConcacaf()) {
  ...
  public void setTablaPartido(ArrayList<Resultados> tablaPartido) {
    ...
    /**
     * @return the tablaConcacaf
     */
    public ArrayList<Selecion> getTablaConcacaf() {
        return tablaConcacaf;
    }

    /**
     * @param tablaConcacaf the tablaConcacaf to set
     */
    public void setTablaConcacaf(ArrayList<Selecion> tablaConcacaf) {
        this.tablaConcacaf = tablaConcacaf;
    }
